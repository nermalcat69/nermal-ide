# fig-convert — Fig autocomplete specs → nermal completion signatures

nermal's per-command completion (flags/subcommands/args with descriptions) is
...
# 2. Convert the commands nermal embeds into assets/completions/.
