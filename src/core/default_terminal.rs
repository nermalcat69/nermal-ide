...
//! narrow promise nermal can make: folders, runnable local files, SSH links, and
//! man-page links.

use std::path::PathBuf;

#[cfg(target_os = "macos")]
pub const BUNDLE_ID: &str = "com.github.nermal";
#[cfg(target_os = "macos")]
...
/// string to [`nermal_core::core::ssh_profile::parse_quick_connect`]. That parser
...
fn quick_connect_from(
    url: &url::Url,
) -> Result<nermal_core::core::ssh_profile::QuickConnect, String> {
    ...
    Ok(nermal_core::core::ssh_profile::QuickConnect {
...
mod tests {
    ...
    fn ssh(raw: &str) -> nermal_core::core::ssh_profile::QuickConnect {
