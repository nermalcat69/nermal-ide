...
/// A keyword the file sets for a host nermal is importing, that no `SshProfile`
...
pub struct ImportReport {
    ...
    /// out here that nermal never opened it.
...
/// an edit made outside nermal is seen on the first tick after the file
...
/// blocks that name at least one host nermal is actually importing.
///
...
/// anyone's host; it is a line about hosts nermal was never asked to import.
