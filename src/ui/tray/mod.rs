...
mod tests {
    ...
    fn attention_follows_waiting_and_tooltip_counts() {
        ...
        assert_eq!(TraySnapshot::default().tooltip(), "nermal");
    }
...
fn deliver(action: TrayAction, workspace: nermal_core::core::session::WorkspaceId, cx: &mut App) {
    use crate::ui::windows::WindowRegistry;
