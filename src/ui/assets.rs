...
fn agent_icon(path: &str) -> Option<&'static [u8]> {
    let bytes: &'static [u8] = match path {
        ...
        "icons/octagon-x.svg" => include_bytes!("../../assets/icons/octagon-x.svg"),
...
mod tests {
    ...
    fn stock_prefix_bypasses_the_overrides() {
        for name in ["search", "ellipsis"] {
            let overridden = Assets
                ...
                .unwrap()
                .expect("nermal override present");
            let stock = Assets
    ...
    fn the_plus_is_drawn_on_the_bound_the_rest_of_the_set_uses() {
        ...
        // icons nermal draws itself put 19.3 units of ink in a 24 viewBox (a 17.2
