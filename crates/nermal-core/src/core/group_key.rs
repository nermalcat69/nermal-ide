...
mod tests {
    ...
    fn a_repo_root_round_trips_as_a_bare_path() {
        let k = GroupKey::Repo(PathBuf::from("/home/u/nermal"));
        assert_eq!(k.encode(), "/home/u/nermal");
        assert_eq!(GroupKey::decode("/home/u/nermal"), Some(k));
    }
    ...
    fn a_custom_group_named_like_a_path_stays_custom() {
        let k = GroupKey::custom("/home/u/nermal").expect("non-blank");
        assert_eq!(k.encode(), "custom:/home/u/nermal");
        assert_eq!(GroupKey::decode(&k.encode()), Some(k.clone()));
        assert!(k.is_custom());
        assert_ne!(k, GroupKey::Repo(PathBuf::from("/home/u/nermal")));
    }
