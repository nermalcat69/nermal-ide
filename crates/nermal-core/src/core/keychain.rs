...
pub const SERVICE_PASSWORD: &str = "nermal-ssh";
pub const SERVICE_KEY_PASSPHRASE: &str = "nermal-ssh-key";
...
mod tests {
    ...
    fn credential_kind_selects_service() {
        assert_eq!(CredentialKind::Password.service(), "nermal-ssh");
        assert_eq!(CredentialKind::KeyPassphrase.service(), "nermal-ssh-key");
    }
