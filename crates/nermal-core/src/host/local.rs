...
/// with no "this one talks to a network" bit, so the remote `nermal-server`
...
impl Host for LocalHost {
    ...
    /// The real path behind `p`, in the spelling the rest of nermal keys by.
    ///
