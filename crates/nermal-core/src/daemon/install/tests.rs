...
fn first_install_runs_all_six_steps() {
    ...
    assert_eq!(
        release.fetched(),
        vec![
            format!("https://github.com/l0ng-ai/nermal/releases/download/v{VERSION}/checksums.txt"),
            format!(
                "https://github.com/l0ng-ai/nermal/releases/download/v{VERSION}/{ASSET_LINUX_X86_64}"
            ),
        ]
    );
}
