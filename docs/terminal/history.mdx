...
That releases <kbd>⌃ R</kbd> and nothing else — <kbd>↑</kbd> still walks nermal's
...
history written outside nermal shows up immediately.

The per-row extras — when you last ran it, whether it failed — come from a small
file nermal keeps alongside it, filled in as you run things. A command nermal has
