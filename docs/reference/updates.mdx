---
title: "Updates"
description: "How nermal updates itself, and what the two channels mean."
---
...
<Steps>
  <Step title="Check">
    nermal checks at launch and every six hours after that. Turn it off entirely
  ...
  <Step title="Update and relaunch">
    A dedicated `nermal-updater` helper verifies the release checksum, the bundle
...
If Settings tells you this, nermal was updated in place: the app is the new build,
