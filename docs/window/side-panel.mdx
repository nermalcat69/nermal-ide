...
<Frame caption="Placeholder — screenshot: the side panel showing the Info tab beside a terminal">
  <img src="/images/placeholder.svg" alt="The nermal side panel" />
</Frame>

## Info

Everything nermal knows about the focused pane, in one column:
...
where" — the same data `nermal procs` prints. A port row copies `localhost:PORT`,
