...
Every action nermal can perform is in here, whether or not it has a keybinding —
...
<Frame caption="Placeholder — screenshot: the command palette open over a terminal, grouped results">
  <img src="/images/placeholder.svg" alt="The nermal command palette" />
</Frame>
...
If no agent is running, nermal says so rather than typing into your shell.
