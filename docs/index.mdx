...
[`scripts/bench/`](https://github.com/l0ng-ai/nermal/tree/main/scripts/bench).
...
<CardGroup cols={3}>
  ...
  <Card title="Issues" icon="github" href="https://github.com/l0ng-ai/nermal/issues">
    Bugs and feature requests.
  </Card>
  <Card title="Changelog" icon="list" href="https://github.com/l0ng-ai/nermal/blob/main/CHANGELOG.md">
