...
<Frame>
  <img src="/images/hero.webp" alt="nermal showing a sidebar of agent sessions across several repositories" />
</Frame>

nermal is a terminal you can leave running. Close the window, reboot the machine,
...
<CardGroup cols={2}>
  <Card title="Sessions that outlive the app" icon="power-off" href="/getting-started/concepts">
    A background server owns your shells, not the window. Quit nermal and your
  ...
  <Card title="Scriptable" icon="terminal" href="/cli/overview">
    A bundled `nermal` CLI that opens panes, sends keys, reads screens, and blocks
...
[`scripts/bench/`](https://github.com/nermalcat69/nermal-ide/tree/main/scripts/bench).
...
<CardGroup cols={3}>
  ...
  <Card title="Issues" icon="github" href="https://github.com/nermalcat69/nermal-ide/issues">
    Bugs and feature requests.
  </Card>
  <Card title="Changelog" icon="list" href="https://github.com/nermalcat69/nermal-ide/blob/main/CHANGELOG.md">
