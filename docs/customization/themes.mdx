...
<Frame caption="Placeholder — screenshot: the theme picker with light and dark sections">
  <img src="/images/placeholder.svg" alt="The nermal theme picker" />
</Frame>

## Following the system

Turn on **Sync with system** and pick a theme for each appearance. nermal follows
...
| | |
|---|---|
| macOS / Linux | `~/.config/nermal/themes/` |
| Windows | `%APPDATA%\nermal\themes\` |
...
Drop an `.itermcolors` file into the themes folder and nermal reads it directly —
no conversion step.

<Note>
  A theme file nermal could not load is listed in Settings under **Not loaded from
